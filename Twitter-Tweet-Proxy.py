...
commentsDict = [
'Berkelanjutan dengan #WayaheGibran: Program yang membangun masa depan, menjaga alam, dan mensejahterakan rakyat! #wayahegibran ',
...
email.send_keys("makayla3480") #replace with your valid twitter username
email.send_keys(Keys.ENTER)
time.sleep(3)
password = driver.find_element_by_name("password")
password.send_keys("ecQDxBG0Q3") #replace with your valid twitter password
